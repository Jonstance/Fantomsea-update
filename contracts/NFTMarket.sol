...
contract NFTMarket is ReentrancyGuard {
 ...
 //_payRoyalty(msg.sender, theCreator, royaltyCashBack);
    }
    else{
  ...
  function _payRoyalty(address buyer, address creator, uint256 royalty) public payable {
        IERC20 token = IERC20(royaltyToken);
        token.transferFrom(buyer, creator, royalty);
    }

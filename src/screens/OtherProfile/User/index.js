...
const User = ({ className, displayName, userBio, userAddress, customUrl, memeberShipDate, avatar}) => {
    ...
    <>
      <div className={cn(styles.user, className)}>
        ...
        <div className={styles.code}>
          <div className={styles.number}>{userAddress}</div>
        ...
        <div className={styles.note}>{`Member since ${memeberShipDate}`} </div>
      </div>
      <Modal
